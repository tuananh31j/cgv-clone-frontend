        ...
        <>
            <Dialog.Root>
                ...
                <Dialog.Portal>
                    ...
                    <Dialog.Content className='data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] w-[90vw] z-50  translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-5 px-10 shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none '>
                        <div>
                            <GroupTabs />
